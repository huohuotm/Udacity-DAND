...
# define function: data set summary 
def dateset_summary():
...
def main():
	...
	outliers_names = ['TOTAL','THE TRAVEL AGENCY IN THE PARK']
	data_dict = remove_outerliers(data_dict,outliers_names) 	# remove outliers
	data_df = pd.DataFrame.from_dict(data_dict,orient='index')  # change data set to dateframe format
